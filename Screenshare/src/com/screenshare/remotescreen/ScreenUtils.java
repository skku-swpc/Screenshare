...
public class ScreenUtils extends Activity {
    ...
    static GLRenderer remoteGLRenderer;
    static Digest digestHttp = new Digest();
    static Digest digestTouch = new Digest();
    static Digest digestWakeScreen = new Digest();
    ...
    public void onCreate(Bundle savedInstanceState) {            	
        ...
        //Create openGL view;        
        remoteGLRenderer = new GLRenderer(this);
        ...
        spinner = new ProgressDialog(ScreenUtils.this);
    ...
    protected void onPause() {
    	super.onPause();    	
  //  	Log.d("Screenshare_java_util: ", "pause");
...
//    	Log.d("Screenshare_java | ScreenUtils: ","url: "+urlTmp);
...
//    	
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
    	switch (item.getItemId()) {
        	case R.id.quality:
                Intent settingsActivity = new Intent(getBaseContext(), QualitySettings.class);
    	...
    	public void handleMessage(final Message msg) {    		
            switch (msg.what) {
            	...
            	case MSG_SHOW_EXCEPITON:
            		try{
//            			Log.d("Screenshare_java: ","http hiba:"+msg.getData().getString("error"));
            			spinner.dismiss();
    ...
    class WakeScreen extends Thread{
    	...
    	public void run(){
    		...
    		while(running){    			    			
    			...
    			try{
 //   				Log.d("Screenshare_hava: ","send wake");
    ...
    class DownloadScreen extends Thread{
		...
		public void run(){									
			while(running){
				...
				if(dismiss){
//					Log.d("Screenshare_java: ","na most kuldok dismisst");
