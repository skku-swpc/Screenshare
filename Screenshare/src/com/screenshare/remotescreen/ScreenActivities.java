...
public class ScreenActivities extends Activity implements OnClickListener{
...
//            Log.e("Screenshare_java | opengl: ","opengl version is to low: "+info.reqGlEsVersion);
//        }        
	}
...
//	    		ed.putBoolean("rscreenproxy", proxy);
            ...
            ed.commit();
	    	startRemoteScreenUtil(username, passwd, address);
	    	break;

		}
	}
	
	public void startRemoteScreenUtil(String uName, String passwd, String address){
		Intent intent = new Intent(context,ScreenUtils.class);
